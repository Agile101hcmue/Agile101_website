    ...
    <div align="center" class="mt-5">
      <div class="col-md-6">
        <div class="h-100 p-5 bg-light border rounded-3">
          <h2 class="mb-4">Tiêu đề promotion 01</h2>
          <img src="./assets/banner1.jpg" alt="" class="img-fluid rounded mx-auto d-block">
          <p class="mt-4">Chi tiết khuyến mãi 01 (promotion 01 description)</p>
          <a href="./components/signup.php">
            <button class="btn btn-outline-secondary" type="button">Vào xem ngay</button>
          </a>
        </div>
      </div>
    </div>

...
<head>
    ...
    <title>Agile101 · Sách Đời Sống</title>
    ...
    <main>
        <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-body-tertiary">
            <div class="col-md-5 p-lg-5 mx-auto my-5">
                <h1 class="display-4 fw-normal">Sách Đời Sống</h1>
                ...
                <?php
                    ...
                    if(mysqli_num_rows($all_product) > 0){
                        while($fetch = mysqli_fetch_assoc($all_product)){
                            ...
                            echo "</div>";
                            echo "<div>";
                            echo "<a href='http://127.0.0.1/Agile101_webite/components/cart/cart.php'><input type='button' class='btn btn-primary mt-4 mb-5' value='Thêm vào giỏ hàng'></a>";
                            echo "</div>";
                            echo "</div>";
                            echo "</div>";
                            echo "</div>";

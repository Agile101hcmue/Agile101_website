    ...
    <main>
        <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-body-tertiary">
            <div class="col-md-5 p-lg-5 mx-auto my-5">
                <h1 class="display-4 fw-normal">Sách Thiếu Nhi</h1>
                <p class="lead fw-normal">Slogan Paragraph  Thêm Slogan Thêm Slogan Thêm Slogan</p>
        ...
        <!-- <div class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
            <div class="text-bg-dark me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
                ...
                <?php
                    ...
                    $query = "select distinct * from `product` where category='sach-truyen' order by id DESC ";
                    ...
                    if(mysqli_num_rows($all_product) > 0){
                        while($fetch = mysqli_fetch_assoc($all_product)){
                            ...
                            echo "</div>";
                            echo "<div>";
                            echo "<a href='http://127.0.0.1/Agile101_website/components/cart/cart.php'><input type='button' class='btn btn-primary mt-4 mb-5' value='Thêm vào giỏ hàng'></a>";
                            echo "</div>";
                            echo "</div>";
                            echo "</div>";
                            echo "</div>";
                        ...
                        // echo "No result!!";
                        echo "<div class='text-center'>Không có kết quả!!</div>";
                    }
